...
//                         {/* <Image src={imageSrc} alt="title" width="384" height="762" quality={100} className="lg:ml-0" /> */}
//                         <Image src={imageSrc} alt="title" width="280" height="560" quality={100} className="lg:ml-0" />
//
//                     </div>
//                 </div>
//             </motion.div>
...
export const imageVariants = {
    ...
    grayscaleOff: {
        ...
        transition: {
            duration: 1,
            delay: 0.5, // Delay biar grayscale ilang belakangan
        }
    }
};
            ...
            >
                ...
                <div className={clsx("mt-5 lg:mt-0", { "lg:order-2": imageAtRight })}>
                    <motion.div
                        ...
                        initial="offscreen"
                        whileInView={["onscreen", "grayscaleOff"]}
                        viewport={{ once: true }}
                    >
                        <Image src={imageSrc} alt="title" width="280" height="560" quality={100} className="lg:ml-0" />
                    </motion.div>
